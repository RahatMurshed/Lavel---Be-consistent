  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsl(180 65% 48% / 0.3)" },
          "50%": { boxShadow: "0 0 30px -2px hsl(180 65% 48% / 0.5)" },
        },
        "slide-up": {
      ...
      animation: {
        ...
        "gradient-shift": "gradient-shift 16s linear infinite",
        "bounce-subtle": "bounce-subtle 0.8s ease-in-out",
      },
    },
  },
